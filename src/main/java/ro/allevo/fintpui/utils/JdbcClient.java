...
public class JdbcClient {
	...
	public ArrayList<MessageReportInstance> getReportsByStroedProcedure(
			Map<String, String> requestParameters, StringBuilder total)
		...
		try {
			if (requestParameters.get("businessArea").equals("Funds Transfer")) {
				...
				while (resultSet.next()) {
					reportInstances.add(MessageReportInstance.getFundsTransferMessage(resultSet));
					if (!gotTotal) {
